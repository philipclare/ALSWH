...
## Test functional forms of severe obesitity analysis
## Date: 27 March 2025
...
analysis_data <- readRDS(paste0(workdir,"Data/severe obesity analysis data - 20240827.rds"))
...
saveRDS(res,file=paste0(workdir,"Results/fit/sev-model-fit-",args[1],".rds"))
