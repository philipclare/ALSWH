...
## Multiple imputation using random forests for sensitivity analysis data
## Date: 26 August 2024
...
imp_data <- readRDS(file=paste0(workdir,"Data/imputation data for sensitivity.rds"))
...
saveRDS(imp,paste0(workdir,"Data/imputed data - long form for sensitivity.rds"))
