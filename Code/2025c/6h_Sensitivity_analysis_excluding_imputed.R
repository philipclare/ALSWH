...
## Sensitivity analysis excluding variables that were wholly imputed in some waves
## Date: 4 June 2025
...
lstubs0 <- c("marital_2","marital_3","age","ariapgp_2","ariapgp_3","employ","live_u18","live_o18","seifadis_2","seifadis_3","seifadis_4","seifadis_5","cesd10","mnstrs","smokst_2","smokst_3","menopause_2","menopause_3","hrt","sleep_cat_1","sleep_cat_2","sleep_cat_4","finfinc","pcsa","mcsa","bmi")
lstubs1 <- c("marital_2","marital_3","age","ariapgp_2","ariapgp_3","employ","live_u18","live_o18","seifadis_2","seifadis_3","seifadis_4","seifadis_5","heartdis_3yr","stroke_3yr","cancer_3yr","arthritis_3yr","depression_3yr","anxiety_3yr","cesd10","mnstrs","smokst_2","smokst_3","menopause_2","menopause_3","hrt","sleep_cat_1","sleep_cat_2","sleep_cat_4","finfinc","pcsa","mcsa","bmi")
...
lstubs3 <- c("marital_2","marital_3","age","ariapgp_2","ariapgp_3","employ","live_u18","live_o18","seifadis_2","seifadis_3","seifadis_4","seifadis_5","heartdis_3yr","stroke_3yr","cancer_3yr","arthritis_3yr","depression_3yr","anxiety_3yr","cesd10","mnstrs","alcliferisk","alcepisrisk","smokst_2","smokst_3","menopause_2","menopause_3","hrt","sleep_prob","finfinc","pcsa","mcsa","bmi")
...
w7_conf <- paste(paste0(lstubs3,"7"),collapse=" + ")
...
analysis_data <- readRDS(paste0(workdir,"Data/primary analysis data - 20240827.rds"))

analysis_data <- analysis_data[[args[1]]]

analysis_data <- subset(analysis_data, select = -c(vegetables3,fruit3,alcliferisk3,alcepisrisk3,vegetables7,fruit7))
...
saveRDS(sum,file=paste0(workdir,"Results/sens2-summary-",args[1],".rds"))
