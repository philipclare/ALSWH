...
## Sensitivity analysis adjusting for descendants of unmeasured confounder
## Date: 4 June 2025
...
add_lstubs <- c("dentist","vitamins","pap_2","pap_3","mam_2","mam_3")
lnodes <- c(paste0(lstubs1,"3"),
            paste0(add_lstubs,"4"),paste0(lstubs2,"4"),
            paste0(add_lstubs,"5"),paste0(lstubs2,"5"),
            paste0(add_lstubs,"6"),paste0(lstubs2,"6"),
            paste0(add_lstubs,"7"),paste0(lstubs2,"7"),
            paste0(add_lstubs,"8"),paste0(lstubs2,"8"),
            paste0(add_lstubs,"9"),
            paste0(add_lstubs,"10"))
...
w4_conf_add <- paste(paste0(add_lstubs,"4"),collapse=" + ")
w5_conf <- paste(paste0(lstubs2,"5"),collapse=" + ")
w5_conf_add <- paste(paste0(add_lstubs,"5"),collapse=" + ")
w6_conf <- paste(paste0(lstubs2,"6"),collapse=" + ")
w6_conf_add <- paste(paste0(add_lstubs,"6"),collapse=" + ")
w7_conf <- paste(paste0(lstubs2,"7"),collapse=" + ")
w7_conf_add <- paste(paste0(add_lstubs,"7"),collapse=" + ")
w8_conf <- paste(paste0(lstubs2,"8"),collapse=" + ")
w8_conf_add <- paste(paste0(add_lstubs,"8"),collapse=" + ")
w9_conf_add <- paste(paste0(add_lstubs,"9"),collapse=" + ")
w10_conf_add <- paste(paste0(add_lstubs,"10"),collapse=" + ")
...
l9_form <- paste(q_base,"activity_bin8",w8_conf,"activity_bin7",w7_conf,sep=" + ")
l10_form <- paste(q_base,"activity_bin9","activity_bin8",w8_conf,sep=" + ")

y4_form <- paste(q_base,"activity_bin3",w2_conf,w4_conf_add,sep=" + ")
y5_form <- paste(q_base,"activity_bin3",w2_conf,"activity_bin4",w3_conf,w5_conf_add,sep=" + ")
y6_form <- paste(q_base,"activity_bin3",w2_conf,"activity_bin4",w3_conf,"activity_bin5",w4_conf,w6_conf_add,sep=" + ")
y7_form <- paste(q_base,"activity_bin3",w2_conf,"activity_bin4",w3_conf,"activity_bin5",w4_conf,"activity_bin6",w5_conf,w7_conf_add,sep=" + ")
y8_form <- paste(q_base,"activity_bin3",w2_conf,"activity_bin4",w3_conf,"activity_bin5",w4_conf,"activity_bin6",w5_conf,"activity_bin7",w6_conf,w8_conf_add,sep=" + ")
y9_form <- paste(q_base,"activity_bin3",w2_conf,"activity_bin4",w3_conf,"activity_bin5",w4_conf,"activity_bin6",w5_conf,"activity_bin7",w6_conf,"activity_bin8",w7_conf,w9_conf_add,sep=" + ")
y10_form <- paste(q_base,"activity_bin3",w2_conf,"activity_bin4",w3_conf,"activity_bin5",w4_conf,"activity_bin6",w5_conf,"activity_bin7",w6_conf,"activity_bin8",w7_conf,"activity_bin9",w8_conf,w10_conf_add,sep=" + ")
...
qform <- c(marital_23=l3_form,
           ...
           obesity9=y9_form,dentist10=l9_form,
           obesity10=y10_form)
...
analysis_data <- readRDS(paste0(workdir,"Data/sensitivity analysis data - 20250606.rds"))
...
saveRDS(sum,file=paste0(workdir,"Results/sens1-summary-",args[1],".rds"))
