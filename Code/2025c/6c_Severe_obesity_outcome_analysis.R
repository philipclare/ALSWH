...
## Secondary analysis of 'severe' obesity (BMI>=35)
## Date: 17 June 2025
...
msm.formula <- "Y ~ cum_exp + max_exp + cum_exp:max_exp"
...
saveRDS(sum,file=paste0(workdir,"Results/severe-summary-",args[1],".rds"))
