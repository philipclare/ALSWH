...
p_pcsa_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pcsa9-1.RData")),
                 read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pcsa9-2.RData")),
                 read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pcsa9-3.RData")),
                 read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pcsa9-4.RData")))
p_mcsa_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mcsa9-1.RData")),
                  read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mcsa9-2.RData")),
                  read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mcsa9-3.RData")),
                  read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mcsa9-4.RData")))
p_pf_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pf9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pf9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pf9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-pf9-4.RData")))
p_rp_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-rp9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-rp9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-rp9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-rp9-4.RData")))
p_bp_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-bp9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-bp9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-bp9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-bp9-4.RData")))
p_gh_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-gh9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-gh9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-gh9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-gh9-4.RData")))
p_vt_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-vt9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-vt9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-vt9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-vt9-4.RData")))
p_sf_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-sf9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-sf9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-sf9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-sf9-4.RData")))
p_re_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-re9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-re9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-re9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-re9-4.RData")))
p_mh_res <- rbind(read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mh9-1.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mh9-2.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mh9-3.RData")),
                read_rdata(file=paste0(workdir,"Results/Katana output/primary-means-mh9-4.RData")))
