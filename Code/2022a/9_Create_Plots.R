...
primary_mi_res_sust <- readRDS(paste0(workdir,"Results/primary-sustained-results.rds"))
...
primary_mi_res_init <- readRDS(paste0(workdir,"Results/primary-iniation-results.rds"))
...
sensitivity_1_mi_res_sust <- readRDS(paste0(workdir,"Results/sensitivity_1-sustained-results.rds"))
...
sensitivity_1_mi_res_init <- readRDS(paste0(workdir,"Results/sensitivity_1-iniation-results.rds"))
...
sensitivity_2_mi_res_sust <- readRDS(paste0(workdir,"Results/sensitivity_2-sustained-results.rds"))
...
sensitivity_2_mi_res_init <- readRDS(paste0(workdir,"Results/sensitivity_2-iniation-results.rds"))
...
sensitivity_3_mi_res_sust <- readRDS(paste0(workdir,"Results/sensitivity_3-sustained-results.rds"))
...
sensitivity_3_mi_res_init <- readRDS(paste0(workdir,"Results/sensitivity_3-iniation-results.rds"))
...
ggsave(paste0(workdir,"Results/primary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/secondary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/primary-initiation 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/secondary-initiation 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s1-primary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s1-secondary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s1-primary-initiation 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s2-primary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s2-primary-initiation 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s2-secondary-initiation 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s3-primary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s3-secondary-sustained 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")
...
ggsave(paste0(workdir,"Results/s3-secondary-initiation 20230608.tiff"),
       width = 2400,
       height = 2400,
       units = "px")