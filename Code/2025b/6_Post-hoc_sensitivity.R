...
regimes <- array(dim = c(n, 6, 64)) #n x num.Anodes x num.regimes
for (cnt in 1:64) {
...
g_base <- "b_country + b_educ + b_language + b_depression_ever + b_anxiety_ever + b_heartdis_ever + b_stroke_ever + b_cancer_ever"
