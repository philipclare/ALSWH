...
## Test functional forms of ten-percent increase in weight analysis
## Date: 27 March 2025
...
# regime_set <- read.csv(paste0(workdir,"Data/regimes.csv"),header=FALSE)
...
analysis_data <- readRDS(paste0(workdir,"Data/weight gain b analysis data - 20240827.rds"))
...
saveRDS(res,file=paste0(workdir,"Results/fit/ten-model-fit-",args[1],".rds"))
