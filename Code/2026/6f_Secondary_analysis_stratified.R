...
## Secondary analysis stratified by education
## Date: 27 August 2024
...
n <- nrow(readRDS(paste0(workdir,"Data/stratified analysis data - wide form 20250606.rds"))[[args[2]]][[args[1]]])
...
q_base <- "Q.kplus1 ~ b_heartdis_ever + b_stroke_ever + b_cancer_ever + b_depression_ever + b_anxiety_ever + b_metmin + b_cobcat + b_pcsa + b_mcsa + "
g_base <- "b_heartdis_ever + b_stroke_ever + b_cancer_ever + b_depression_ever + b_anxiety_ever + b_metmin + b_cobcat + b_pcsa + b_mcsa + "
...
analysis_data <- readRDS(paste0(workdir,"Data/stratified analysis data - wide form 20250606.rds"))

analysis_data <- analysis_data[[args[2]]][[args[1]]]
...
saveRDS(sum,file=paste0(workdir,"Results/stratified-summary-",strata,"-",args[2],".rds"))
